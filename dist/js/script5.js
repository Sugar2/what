!function (e) {
    ...
    }, t.p = "https://static.squarespace.com/universal/scripts-compressed/", t(t.s = 10837)
}({
    10836: function (e, t, n) {
        !function (t, n) {
            e.exports = n()
        }(window, function () {
            return function (e) {
                ...
                t.WP_RUM_URLS = {
                    ...
                    return {
                        data: {__encoding_action__: e, __encoding_key__: "d"},
                        event: {
                    ...
                    app: "a",
                    connection: {__encoding_action__: t.CONNECTION_DATA_CODES, __encoding_key__: "con"},
                    context: "ctx",
                    hash: "h",
                    marketingId: "mid",
                    pageLoadId: "pl",
                    ...
                    name: "n",
                    startTime: "st"
                }), t.TTI_DATA_CODES = o.default({}, t.GLOBAL_DATA_CODES, {tti: "t"}), t.PAINT_DATA_CODES = o.default({}, t.GLOBAL_DATA_CODES, {
                ...
                "use strict";
                Object.defineProperty(t, "__esModule", {value: !0});
                var r = n(0), o = n(6), i = n(5), a = function () {
                    function e() {
                ...
                "use strict";
                Object.defineProperty(t, "__esModule", {value: !0}), t.interactionTimingSupported = function () {
                ...
                t.getPerformanceData = function () {
                    ...
                    var n = Object.freeze({data: t, event: e, ts: Date.now()});
                    return r(n), n
                }
            }, function (e, t, n) {
                "use strict";
                ...
                function o(e, t) {
                    "function" == typeof window.dispatchEvent && "function" == typeof CustomEvent && window.dispatchEvent(new CustomEvent(e, {detail: t}))
                }
                ...
                t.mark = function (e) {
                    ...
                    if (r() && "performance" in window && "getEntries" in window.performance && "getEntriesByType" in window.performance && "getEntriesByName" in window.performance) {
                        var t = "rum-start-" + e, n = "rum-end-" + e, a = "rum-" + e;
                        window.performance.mark(n), window.performance.measure(a, t, n);
                        var u = window.performance.getEntriesByName(a), c = u[u.length - 1];
                ...
                Object.defineProperty(t, "__esModule", {value: !0});
                var i = n(0), a = n(2), u = o(n(4)), c = function (e) {
                    function t() {
                ...
                (function (n) {
                    ...
                    !function () {
                        ...
                        function u(e) {
                            var t = 0;
                            return function (e) {
                                return a(), (e = {next: e})[v.Symbol.iterator] = function () {
                                    return this
                                }, e
                            }(function () {
                        ...
                        function f(e, t) {
                            for (var n = (e = c(e)).next(); !n.done; n = e.next()) if (n = n.value, t.includes(n.nodeName.toLowerCase()) || f(n.children, t)) return !0;
                            return !1
                        }
                        ...
                        function d(e) {
                            ...
                            }) : [], t && t.disconnect(), this.b = [], this.f = new Map, this.j = null, this.v = -1 / 0, this.i = !1, this.h = this.c = this.s = null, function (e, t) {
                                var n = XMLHttpRequest.prototype.send, r = m++;
                            ...
                            }(this.m.bind(this), this.l.bind(this)), function (e, t) {
                                var n = fetch;
                                fetch = function (r) {
                            ...
                            }(this.m.bind(this), this.l.bind(this)), function (e) {
                                e.c = new PerformanceObserver(function (t) {
                                    for (var n = (t = c(t.getEntries())).next(); !n.done; n = t.next()) if ("resource" === (n = n.value).entryType && (e.b.push({
                                        start: n.fetchStart,
                                        end: n.responseEnd
                                    }), _(e, p(e.g, e.b) + 5e3)), "longtask" === n.entryType) {
                                        var r = n.startTime + n.duration;
                                        e.a.push({start: n.startTime, end: r}), _(e, r + 5e3)
                                    }
                        ...
                        function l(e) {
                            e.i = !0;
                            var t = 0 < e.a.length ? e.a[e.a.length - 1].end : 0, n = p(e.g, e.b);
                            _(e, Math.max(n + 5e3, t))
                        }

                        function _(e, t) {
                            !e.i || e.v > t || (clearTimeout(e.j), e.j = setTimeout(function () {
                                var t = performance.timing.navigationStart, n = p(e.g, e.b);
                                if (t = (window.a && window.a.A ? 1e3 * window.a.A().C - t : 0) || performance.timing.domContentLoadedEventEnd - t, e.u) var r = e.u; else r = performance.timing.domContentLoadedEventEnd ? (r = performance.timing).domContentLoadedEventEnd - r.navigationStart : null;
                        ...
                        var v = "undefined" != typeof window && window === this ? this : void 0 !== n && null != n ? n : this,
                            ...
                            }, h = 0, m = 0, E = "img script iframe link audio video source".split(" ");
                ...
                Object.defineProperty(t, "__esModule", {value: !0});
                var i = o(n(3)), a = n(15), u = n(0), c = function (e) {
                    function t(t) {
                        var n = e.call(this) || this;
                        return n.eventName = "tti", n.entryType = "longtask", n.supportType = "observe", n.encodeMap = u.RUM_RECORD_DATA_CODES(u.TTI_DATA_CODES), n.fireOnce = !0, window.PerformanceLongTaskTiming && window.PerformanceObserver ? (window.__tti = {e: []}, a.getFirstConsistentlyInteractive().then(function (e) {
                            n.parse(i.default({}, t, {tti: e})), n.deliver()
                        })) : n.supportType = "", n
                    }
                ...
                var i = n(0), a = function (e) {
                    ...
                    return r(t, e), t.prototype.observerParse = function (e) {
                        var t = this, n = e.name, r = e.startTime;
                ...
                Object.defineProperty(t, "__esModule", {value: !0});
                var i = n(0), a = o(n(4)), u = function (e) {
                    function t() {
                ...
                var i = n(0), a = n(2), u = function (e) {
                    ...
                    return r(t, e), t.prototype.gather = function (e) {
                        ...
                        return {eventType: e.type, timestamp: t}
                    }, t.prototype.gatherParse = function (e) {
                ...
                Object.defineProperty(t, "__esModule", {value: !0}), t.default = function e(t, n) {
                    var o = {};
                    for (var i in t) if (i in n) {
                        var a = t[i], u = n[i], c = void 0;
                        if ("object" == typeof a) {
                            var s = a.__encoding_action__;
                            if (a = a.__encoding_key__, "object" == typeof s) c = e(s, u); else {
                ...
                var i = n(0), a = n(2), u = function (e) {
                    ...
                    return r(t, e), t.prototype.gather = function (e) {
                        var t = e.timeStamp, n = t > 1e12 ? +new Date : window.performance.now();
                        return {delay: Math.max(n - t, 0), eventType: e.type}
                    }, t.prototype.gatherParse = function (e) {
                ...
                Object.defineProperty(t, "__esModule", {value: !0});
                var o = r(n(21)), i = r(n(19)), a = r(n(18)), u = r(n(17)), c = r(n(16)), s = r(n(13));
                ...
                function o(e) {
                    for (; (e.timeRemaining() > 0 || e.didTimeout) && l.length;) {
                        var t = l.shift();
                        t && t.deliver()
                    }
                    u = l.length ? window.requestIdleCallback(o, {timeout: _}) : void 0
                }

                function i(e) {
                    window.requestIdleCallback ? function (e) {
                        l.push(e), u || (u = window.requestIdleCallback(o, {timeout: _}))
                    }(e) : e.deliver()
                }
                ...
                Object.defineProperty(t, "__esModule", {value: !0});
                var u, c = a(n(3)), s = a(n(22)), f = a(n(12)), p = a(n(11)), d = a(n(8)), l = [], _ = 2e3;
                t.init = function (e) {
                    var t = p.default(e), n = [];
                    if (s.default.map(function (e) {
                        ...
                        if ("observe" === o) {
                            ...
                            var s = e.getGatherEvents(), p = e.getEventName(), l = function (n) {
                        ...
                        var o = function (e) {
                            e.forEach(function (e) {
                                var t = new CustomEvent(r(e.entryType), {detail: e.toJSON()});
                ...
                t.default = r.init;
                var o = n(5);
                t.getPerformanceData = o.getPerformanceData, function (e) {
        ...
        if (window.top === window) {
            ...
            if (o) {
                var i = o.website || {}, a = o.websiteSettings || {}, u = o.collection || {};
                (0, r.default)({
